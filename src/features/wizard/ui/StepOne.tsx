  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        <h2 className="text-3xl font-bold text-balance">Choose Your Website Type</h2>
        <p className="text-muted-foreground text-pretty">Select the type of website you want to create</p>
      </div>
